...
export const Field = ({ value, type, loader, onClick }) => {
    return (
        <div className="mt-2 flex relative h-10">
            <div className="flex shrink-0 items-center rounded-l-md px-3 text-base text-white analyze outline outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6 w-20">
            ...
            <div className="-ml-px block w-2 grow rounded-r-md pl-3 pr-7 py-1.5 text-base text-white outline outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6">
